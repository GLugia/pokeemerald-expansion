...
{
    [NATURE_BRAWNY]  = PALACE_TARGET_STRONGER,
    ...
    [NATURE_GUARDED] = PALACE_TARGET_RANDOM, 
    ...
    [NATURE_NEUTRAL] = PALACE_TARGET_WEAKER,
    ...
    [NATURE_WILD]    = PALACE_TARGET_WEAKER,
    ...
    [NATURE_WISE]    = PALACE_TARGET_STRONGER,
};
