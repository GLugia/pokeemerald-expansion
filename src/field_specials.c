...
void ShowNatureGirlMessage(void)
{
    static const u8 *const sNatureGirlMessages[NUM_NATURES] = {
	    ...
	    [NATURE_BRAWNY]  = BattleFrontier_Lounge5_Text_NatureGirlHardy,
        ...
        [NATURE_GUARDED] = BattleFrontier_Lounge5_Text_NatureGirlDocileNaiveQuietQuirky,
        ...
        [NATURE_WILD]    = BattleFrontier_Lounge5_Text_NatureGirlDocileNaiveQuietQuirky,
