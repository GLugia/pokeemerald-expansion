...
#else
static void BufferFanClubTrainerName_(u8 a, u8 b);
#endif
...
void ShowNatureGirlMessage(void)
{
    static const u8 *const sNatureGirlMessages[NUM_NATURES] = {
        [NATURE_GUARDED]   = BattleFrontier_Lounge5_Text_NatureGirlHardy,
        ...
        [NATURE_BRAWNY]  = BattleFrontier_Lounge5_Text_NatureGirlDocileNaiveQuietQuirky,
        ...
        [NATURE_NEUTRAL] = BattleFrontier_Lounge5_Text_NatureGirlSerious,
        ...
        [NATURE_WILD] = BattleFrontier_Lounge5_Text_NatureGirlBashful,
        ...
        [NATURE_WISE]  = BattleFrontier_Lounge5_Text_NatureGirlDocileNaiveQuietQuirky,
    };
