...
u32 GetBoxMonData(struct BoxPokemon *boxMon, s32 field, u8 *data)
{
    ...
    case MON_DATA_LANGUAGE: // TODO (lilua): remove unused data
        retVal = LANGUAGE_ENGLISH;
        break;
    case MON_DATA_SANITY_IS_BAD_EGG: // TODO (lilua): remove unused data
        retVal = FALSE;
        break;
    case MON_DATA_SANITY_HAS_SPECIES:
        retVal = boxMon->species > SPECIES_NONE && boxMon->species < SPECIES_EGG;
        break;
    ...
    case MON_DATA_MARKINGS:
        ...
        break;
    case MON_DATA_CHECKSUM: // TODO (lilua): remove unused data
        retVal = 0;
        break;
    case MON_DATA_ENCRYPT_SEPARATOR: // TODO (lilua): remove unused data
        retVal = 0;
        break;
    ...
    case MON_DATA_MOVE4:
		...
		break;
    case MON_DATA_PP1:
		retVal = CalculatePPWithBonus(boxMon->move1, boxMon->ppBonuses, 0);
		break;
    case MON_DATA_PP2:
		retVal = CalculatePPWithBonus(boxMon->move2, boxMon->ppBonuses, 1);
		break;
    case MON_DATA_PP3:
		retVal = CalculatePPWithBonus(boxMon->move3, boxMon->ppBonuses, 2);
		break;
    case MON_DATA_PP4:
		retVal = CalculatePPWithBonus(boxMon->move4, boxMon->ppBonuses, 3);
		break;
    case MON_DATA_HP_EV:
        retVal = boxMon->hpEV;
        break;
    ...
    case MON_DATA_GIFT_RIBBON_4:
        ...
        break;
    case MON_DATA_GIFT_RIBBON_5: // TODO (lilua): remove unused data
        retVal = FALSE;
        break;
    case MON_DATA_GIFT_RIBBON_6: // TODO (lilua): remove unused data
        retVal = FALSE;
        break;
    case MON_DATA_GIFT_RIBBON_7: // TODO (lilua): remove unused data
        retVal = FALSE;
        break;
    case MON_DATA_FATEFUL_ENCOUNTER: // TODO (lilua): remove unused data
        retVal = 0;
        break;
    ...
    case MON_DATA_RIBBONS:
        ...
        if (boxMon->species && !boxMon->isEgg)
        {
            retVal = boxMon->championRibbon
                ...
                | (boxMon->giftRibbon1 << 20)
                | (boxMon->giftRibbon2 << 21)
                | (boxMon->giftRibbon3 << 22)
                | (boxMon->giftRibbon4 << 23)
                | (FALSE << 24)
                | (FALSE << 25)
                | (FALSE << 26);
        }
...
void SetBoxMonData(struct BoxPokemon *boxMon, s32 field, const void *dataArg)
{
    ...
    case MON_DATA_LANGUAGE:	// TODO (lilua): remove useless data
        break;
    ...
    case MON_DATA_MET_GAME:	// TODO (lilua): remove useless data
        break;
    case MON_DATA_POKEBALL:
    {
        u8 pokeball = *data;
    ...
    case MON_DATA_GIFT_RIBBON_4:
        ...
        break;
    case MON_DATA_GIFT_RIBBON_5:	// TODO (lilua): remove useless data
