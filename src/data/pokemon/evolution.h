const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_KADABRA]               = {{EVO_LEVEL, 37, SPECIES_ALAKAZAM}},
	...
	// TODO (lilua): implement EVO_SPECIAL. it should activate when the second variable is not 0
	[SPECIES_FARFETCHD]				= {{EVO_LEVEL, 25, SPECIES_SIRFETCHD}},
    ...
    [SPECIES_ONIX]                  = {{EVO_ITEM_HOLD_DAY, ITEM_METAL_COAT, SPECIES_STEELIX},
									   {EVO_ITEM_HOLD_NIGHT, ITEM_METAL_COAT, SPECIES_STEELIX}},
    ...
    [SPECIES_SCYTHER]               = {{EVO_ITEM_HOLD_DAY, ITEM_METAL_COAT, SPECIES_SCIZOR},
									   {EVO_ITEM_HOLD_NIGHT, ITEM_METAL_COAT, SPECIES_SCIZOR}},
    [SPECIES_ELECTABUZZ]            = {{EVO_ITEM_HOLD_DAY, ITEM_ELECTIRIZER, SPECIES_ELECTIVIRE},
									   {EVO_ITEM_HOLD_DAY, ITEM_ELECTIRIZER, SPECIES_ELECTIVIRE}},
	...
	[SPECIES_JOLTEON]              = {{EVO_ITEM, ITEM_WATER_STONE, SPECIES_JOLTEON},
									{EVO_ITEM, ITEM_WATER_STONE, SPECIES_VAPOREON},
									{EVO_ITEM, ITEM_FIRE_STONE, SPECIES_FLAREON},
									{EVO_ITEM, ITEM_DAWN_STONE, SPECIES_ESPEON},
									{EVO_ITEM, ITEM_DUSK_STONE, SPECIES_UMBREON},
	...
	[SPECIES_SYLVEON]            = {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_JOLTEON},
									...
									{EVO_ITEM, ITEM_LEAF_STONE, SPECIES_LEAFEON},
									{EVO_ITEM, ITEM_ICE_STONE, SPECIES_GLACEON}},
    [SPECIES_PORYGON]               = {{EVO_LEVEL, 0, SPECIES_PORYGON}},
    ...
    [SPECIES_GLIGAR]                = {{EVO_ITEM_HOLD_DAY, ITEM_RAZOR_FANG, SPECIES_GLISCOR},
									   {EVO_ITEM_HOLD_NIGHT, ITEM_RAZOR_FANG, SPECIES_GLISCOR}},
    [SPECIES_SNUBBULL]              = {{EVO_LEVEL, 23, SPECIES_GRANBULL}},
    [SPECIES_SNEASEL]               = {{EVO_ITEM_HOLD_DAY, ITEM_RAZOR_CLAW, SPECIES_WEAVILE},
    ...
    [SPECIES_CLAMPERL]              = {{EVO_ITEM_HOLD_DAY, ITEM_DEEP_SEA_TOOTH, SPECIES_HUNTAIL},
									   {EVO_ITEM_HOLD_NIGHT, ITEM_DEEP_SEA_TOOTH, SPECIES_HUNTAIL},
                                       {EVO_ITEM_HOLD_DAY, ITEM_DEEP_SEA_SCALE, SPECIES_GOREBYSS},
                                       {EVO_ITEM_HOLD_NIGHT, ITEM_DEEP_SEA_SCALE, SPECIES_GOREBYSS}},
	...
	[SPECIES_LUVDISC]				= {{EVO_FRIENDSHIP, 0, SPECIES_ALOMOMOLA},
										{EVO_BEAUTY, 0, SPECIES_ALOMOMOLA}},
    ...
    [SPECIES_HAPPINY]               = {{EVO_ITEM_HOLD_DAY, ITEM_OVAL_STONE, SPECIES_CHANSEY},
									   {EVO_ITEM_HOLD_NIGHT, ITEM_OVAL_STONE, SPECIES_CHANSEY}},
	...
	[SPECIES_PORYGON_Z]             = {{EVO_LEVEL,45, SPECIES_PORYGON2}},
