...
const u32 gMonFrontPic_Sirfetchd[] = INCBIN_U32("graphics/pokemon/sirfetchd/front.4bpp.lz");	// TODO (lilua): make another frame for animation
...
const u8 gMonFootprint_Sirfetchd[] = INCBIN_U8("graphics/pokemon/farfetchd/footprint.1bpp");
...
const u8 gMonFootprint_Sylveon[] = INCBIN_U8("graphics/pokemon/glaceon/footprint.1bpp");
