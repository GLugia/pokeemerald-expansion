...
static const u8 sBrawnyNatureName[] = _("BRAWNY");
...
static const u8 sGuardedNatureName[] = _("GUARDED");
...
static const u8 sNeutralNatureName[] = _("NEUTRAL");
