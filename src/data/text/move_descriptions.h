...
const u8 *const gMoveDescriptionPointers[MOVES_COUNT - 1] =
{
    ...
    [MOVE_VICE_GRIP - 1] = sViseGripDescription,
    ...
    [MOVE_SOLARBEAM - 1] = sSolarBeamDescription,
    ...
    [MOVE_HI_JUMP_KICK - 1] = sHighJumpKickDescription,
    ...
    [MOVE_FAINT_ATTACK - 1] = sFeintAttackDescription,
    ...
    [MOVE_SMELLING_SALT - 1] = sSmellingSaltsDescription,
