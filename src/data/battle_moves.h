const struct BattleMove gBattleMoves[MOVES_COUNT] =
{
	...
	[MOVE_HYDRO_PUMP] =
	{
		.effect = EFFECT_HIT,	// TODO give special effects to the 110/80/5 moves then change them to 100/90/10
		.power = 110,
		.type = TYPE_WATER,
		.accuracy = 80,
		.pp = 5,
	...
	{
		.power = 80,
		.effect = EFFECT_SPEED_UP_HIT,	// EFFECT_FLINCH_HIT
		.type = TYPE_WATER,
		.accuracy = 100,
		.pp = 15,
		.secondaryEffectChance = 20,
	...
	[MOVE_FLASH] =
	{
		.effect = EFFECT_ACCURACY_DOWN_HIT,	// EFFECT_ACCURACY_DOWN
		.power = 40,	// 0
		.type = TYPE_ELECTRIC,	// NORMAL
		.accuracy = 100,
		.pp = 20,
		.secondaryEffectChance = 100,	// 0
		.target = MOVE_TARGET_SELECTED,
		.priority = 0,
		.flags = FLAG_PROTECT_AFFECTED | FLAG_MAGIC_COAT_AFFECTED | FLAG_MIRROR_MOVE_AFFECTED,
		.split = SPLIT_STATUS,
	...
	{
		.effect = EFFECT_HYPER_FANG,	// EFFECT_FLINCH_HIT
		.power = 1,	// 80
		.type = TYPE_NORMAL,
		.accuracy = 95,	// 90
		.pp = 15,
	...
	[MOVE_AEROBLAST] =
	{
		.effect = EFFECT_SPEED_DOWN_HIT, // EFFECT_HIT
		.power = 100,
		.type = TYPE_FLYING,
		.accuracy = 95,
		.pp = 5,
		.secondaryEffectChance = 30,	// 0
		.target = MOVE_TARGET_SELECTED,
		.priority = 0,
		.flags = FLAG_PROTECT_AFFECTED | FLAG_MIRROR_MOVE_AFFECTED | FLAG_KINGS_ROCK_AFFECTED | FLAG_HIGH_CRIT,
		.split = SPLIT_SPECIAL,
	...
	[MOVE_WEATHER_BALL] =
	{
		...
		.priority = 0,
		.flags = FLAG_PROTECT_AFFECTED | FLAG_MIRROR_MOVE_AFFECTED | FLAG_KINGS_ROCK_AFFECTED | FLAG_BALLISTIC,
		.split = SPLIT_DYNAMIC,	// SPLIT_SPECIAL
	},
	...
	[MOVE_AIR_CUTTER] =
	{
		.effect = EFFECT_FLINCH_HIT,	// EFFECT_HIT
		.power = 60,
		.type = TYPE_FLYING,
		.accuracy = 95,
		.pp = 25,
	...
	[MOVE_SHADOW_PUNCH] =
	{
		...
		.target = MOVE_TARGET_SELECTED,
		.priority = 0,
		.flags = FLAG_MAKES_CONTACT | FLAG_MIRROR_MOVE_AFFECTED | FLAG_KINGS_ROCK_AFFECTED | FLAG_IRON_FIST_BOOST,
	...
	[MOVE_SHEER_COLD] =	// TODO (lilua): change ohko moves to be recoil?
	{
		.effect = EFFECT_OHKO,
		.power = 1,
		.type = TYPE_ICE,
	...
	// TODO (lilua): change all 120/100/recoil moves to have a secondary effect similar to MOVE_FLARE_BLITZ
	[MOVE_WOOD_HAMMER] =
	{
		.effect = EFFECT_RECOIL_25,
		.power = 120,
	...
	[MOVE_ATTACK_ORDER] =
	{
		.effect = EFFECT_DEFENSE_DOWN_HIT,	// EFFECT_HIT
		.power = 80,	// 90
		.type = TYPE_BUG,
		.accuracy = 100,
		.pp = 15,
	...
	[MOVE_HEAD_CHARGE] =
	{
		.effect = EFFECT_RECOIL_33_STATUS,	// 25
		.power = 120,
		.type = TYPE_NORMAL,
		.accuracy = 100,
		.pp = 15,
		.secondaryEffectChance = 10,	// 0
		.target = MOVE_TARGET_SELECTED,
		.priority = 0,
		.flags = FLAG_MAKES_CONTACT | FLAG_PROTECT_AFFECTED | FLAG_MIRROR_MOVE_AFFECTED | FLAG_KINGS_ROCK_AFFECTED | FLAG_RECKLESS_BOOST,
		.split = SPLIT_PHYSICAL,
	...
	[MOVE_GLACIATE] =
	{
		.effect = EFFECT_FREEZE_HIT,	// EFFECT_SPEED_DOWN_HIT
		.power = 70,					// 65
		.type = TYPE_ICE,
		.accuracy = 95,
		.pp = 10,
		.secondaryEffectChance = 30,	// 100
		.target = MOVE_TARGET_BOTH,
		.priority = 0,
		.flags = FLAG_PROTECT_AFFECTED | FLAG_MIRROR_MOVE_AFFECTED | FLAG_SHEER_FORCE_BOOST,
		.split = SPLIT_SPECIAL,
	...
	[MOVE_ICICLE_CRASH] =
	{
		.effect = EFFECT_RECOIL_33_STATUS,	// EFFECT_FLINCH_HIT
		.power = 120,						// 85
		.type = TYPE_ICE,
		.accuracy = 100,					// 90
		.pp = 15,							// 10
		.secondaryEffectChance = 10,		// 30
		.target = MOVE_TARGET_SELECTED,
		.priority = 0,
		.flags = FLAG_MAKES_CONTACT | FLAG_PROTECT_AFFECTED | FLAG_MIRROR_MOVE_AFFECTED | FLAG_KINGS_ROCK_AFFECTED | FLAG_SHEER_FORCE_BOOST | FLAG_RECKLESS_BOOST,
		.split = SPLIT_PHYSICAL,
