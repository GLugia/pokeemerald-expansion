...
void PressurePPLose(u16 target, u16 attacker, u16 move);
void PressurePPLoseOnUsingPerishSong(u16 attacker);
void PressurePPLoseOnUsingImprison(u16 attacker);
...
bool32 IsMoveMakingContact(u16 move, u16 battlerAtk);
bool32 IsBattlerGrounded(u8 battlerId);
bool32 IsBattlerAlive(u8 battlerId);
u8 GetBattleMonMoveSlot(struct BattlePokemon *battleMon, u16 move);
u32 GetBattlerWeight(u8 battlerId);
s32 CalculateMoveDamage(u16 move, u16 battlerAtk, u16 battlerDef, u8 moveType, s32 fixedBasePower, bool32 isCrit, bool32 randomFactor, bool32 updateFlags);
u16 CalcTypeEffectivenessMultiplier(u16 move, u8 moveType, u16 battlerAtk, u16 battlerDef, bool32 recordAbilities);
