...
#define FREE_SAVE_BLOCK

#ifdef FREE_SAVE_BLOCK
// SaveBlock1
#define FREE_EXTRA_SEEN_FLAGS			//  104
#define FREE_FIELD_3598					//  384
#define FREE_TRAINER_HILL				//   28
#define FREE_MYSTERY_EVENT_BUFFERS		// 1880
// TODO (lilua): temp
//#define FREE_MATCH_CALL				//  104
#define FREE_UNION_ROOM_CHAT			//  210
#define FREE_ENIGMA_BERRY				//   52
#define FREE_LINK_BATTLE_RECORDS		//   88
//#define FREE_TV_SHOWS					//  900
//									Total: 3750

// SaveBlock2
//#define FREE_BATTLE_TOWER_APPRENTICE	//  272
#define FREE_BATTLE_TOWER_EREADER		//  188
#define FREE_POKEMON_JUMP				//   16
#define FREE_RECORD_MIXING				// 1032
//									Total: 1508
...
struct BattleFrontier
{
	...
	#ifndef FREE_BATTLE_TOWER_EREADER
...
struct SaveBlock2
{
	...
	#ifndef FREE_BATTLE_TOWER_APPRENTICE
...
struct SaveBlock1
{
    ...
    /*0x2e64*/ struct EasyChatPair easyChatPairs[5]; //Dewford trend [0] and some other
													 // stuff
    /*0x2e90*/ struct ContestWinner contestWinners[NUM_CONTEST_WINNERS]; // see
																		 // CONTEST_WINNER_*
